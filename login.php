                ...
                <div class="auth-wrapper auth-v2">
                    <div class="auth-inner row m-0">
                        <!-- Brand logo--><a class="brand-logo" href="javascript:void(0);">
                            ...
                            <h2 class="brand-text text-primary ml-1">ToDo</h2>
                        </a>
                        <!-- /Brand logo-->
                        <!-- Left Text-->
                        ...
                        <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                                <h4 class="card-title mb-1">Todo Hoşgeldiniz 👋</h4>
                                <p class="card-text mb-2">Lütfen Kullanıcı Adı Ve Parolanızı Giriniz</p>
                                <form class="auth-login-form mt-2" action="islem2.php" method="POST">
                                    ...
                                    <div class="form-group">
                                        <div class="d-flex justify-content-between">
                                            <label name="sifre" for="login-password">Şifre</label><a href="page-auth-forgot-password-v2.html"><small>Şifremi Unuttum</small></a>
                                        </div>
                                    ...
                                    <button class="btn btn-primary btn-block" name="giris" tabindex="4">Giriş</button>
                                </form>
